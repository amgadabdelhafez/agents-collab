# Tasks: Claude Startup Readiness Timeout Preservation

- [x] Reproduce and trace readiness-timeout teardown to the untyped error path.
- [x] Define the preservation contract and explicit non-goals.
- [x] Add the typed readiness-timeout lifecycle boundary.
