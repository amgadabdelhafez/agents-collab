# Tasks: Utility Result Consumption

- [x] Add a producer-backed regression for a completed durable utility job.
- [x] Resolve only its matching queued handover on `get_task_result`.
