...
- [x] Add failing context loader, route request, bridge, runtime, and observability tests.
- [x] Implement protected instructions and bounded selected-reference loading.
- [x] Add context refs, deterministic capsule metadata, persistence, and prompt composition.
