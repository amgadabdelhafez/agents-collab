# Regression Eval: stale-live-worker-router-binary

Generated: 2026-07-27T06:16:15Z
Source task: `worker-routing-live-integration`
Status: draft

## Failure Symptom

- Live governess does not run the merged widened classifier.

## Guard Evidence

- combined focused routing/governess suites plus live binary hash and pane PID checks

## Verification Artifacts

- `integration`: `runs/worker-routing-live-integration/artifacts/integration/verify.log` (sign-off-granted)
- `smoke`: `runs/worker-routing-live-integration/artifacts/smoke/verify.log` (pass)
- `unit`: `runs/worker-routing-live-integration/artifacts/unit/verify.log` (pass)
...
- Smoke attempt 004 passed targeted formatting/checks, build, and
  `git diff --check`.
