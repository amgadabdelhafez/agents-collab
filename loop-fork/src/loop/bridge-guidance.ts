...
export const mandatoryUtilityDelegationGuidance = (
  ...
  return [
    ...(activation === "on-request"
      ...
      : []),
    `Delegation is mandatory once you are actively handling an assigned request for clearly bounded, separable work that does not require current-session judgment: call ${routeTool} with work_shape=separable before using a native repository tool, even when you could do the work yourself. Never label ambiguous or sequence-dependent work separable.`,
    ...
    "Native tools remain appropriate for governing instructions, architecture, product/release decisions, ambiguous, sequential, or cross-cutting work, peer verdicts, and reviewing returned worker evidence. Being the assigned reviewer does not prevent you from sending separate non-authoritative utility audits to Au Pair.",
